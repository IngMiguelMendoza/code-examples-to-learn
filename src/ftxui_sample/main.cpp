...
// configuration step. It creates a namespace called `code_examples_to_learn`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", code_examples_to_learn::cmake::project_name, code_examples_to_learn::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", code_examples_to_learn::cmake::project_version);
      return EXIT_SUCCESS;
    }
